...
<head>
    ...
    <link rel="stylesheet" href="Template admin/assets/bundles/jquery-selectric/selectric.css">
    <!-- Template CSS -->
    ...
    <link rel='shortcut icon' type='image/x-icon' href='Template admin/assets/img/favicon.ico' />
</head>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="agree" class="custom-control-input"
                                                id="agree">
                                            <label class="custom-control-label" for="agree">Eu concordo com os Termos
                                                e Condições</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
