    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Agendar Evento</li>
            </ol>
        </nav>
    </div>
    <div class="card text-left">
        <div class="card-body">
            <form action="{{ route('eventos.store') }}" method="POST" id="InserirForm" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control @error('data_inicio') is-invalid @enderror"
                                        name="data_inicio" type="datetime-local" />
                                    @error('data_inicio')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                                <div class="form-group mb-3"><label class="form-label" for="temas">Temas</label>
                                    <input type="text" placeholder="separe por virgula os temas"
                                        class="form-control inputtags @error('temas') is-invalid @enderror" name="temas">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-9">
                                <div class="form-group mb-3">
                                    ...
                                    @enderror"
                                        name="resumo" maxlength="376"></textarea>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-12">
                                <div class="form-group mb-3">
                                    ...
                                    @enderror"
                                        name="descricao" maxlength="376"></textarea>
                                    @error('descricao')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
