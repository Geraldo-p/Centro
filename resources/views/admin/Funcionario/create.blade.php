                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                                            <div class="form-group mb-3"><label class="form-label"
                                                                    ...
                                                                    type="number" name="telefone" inputmode="tel"
                                                        ...
                                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                                            <div class="form-group mb-3"><label class="form-label"
                                                                    ...
                                                                    type="number" name="telefoneOP" inputmode="tel"
                                            ...
                                            <div class="row profile-row">
                                                <div class="col-md-8 col-lg-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-6 col-lg-5 col-lg-3 col-lg-5">
                                                            <div class="form-group fallback mb-3"><label
                                                                    class="form-label" for="documentos">Documentos</label>
                                                                <input
                                                                    class="form-control @error('documentos') is-invalid @enderror"
                                                                    type="file" name="documentos" accept=".pdf" />
                                                                @error('documentos')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
