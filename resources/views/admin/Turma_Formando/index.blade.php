...
@section('content')
    <section class="section">
        <div class="page-header d-flex justify-content-between align-items-center">
            <h3 class="page-title">Funcionarios</h3>
        ...
        <div class="row">
                                            ...
                                            <td>
                                                <div>
                                                    <form id="deleteForm-{{ $item->id }}"
                                                        action="{{ route('funcionarios.destroy', $item) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                        ...
                                                        <a href="{{ route('funcionarios.show', $item->id) }}"
            ...
            <div class="col-12 d-flex align-items-center">
                <a class="btn btn-primary mr-2" href="{{ route('funcionarios.create') }}" role="button">+ Novo</a>
                <a class="btn btn-danger" href="{{ route('funcionarios.pdf') }}" role="button">
