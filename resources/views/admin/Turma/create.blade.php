...
@section('content')
    ...
    <div class="card text-left">
        <div class="card-body">
            <form action="{{ route('turmas.store') }}" method="POST" id="InserirForm" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control @error('horario_SAIDA') is-invalid @enderror" type="time"
                                        name="horario_SAIDA" />
