            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="iq_teacher_style_1">
                        <figure>
                            ...
                            <img src="{{ asset('Template user/extra-images/teacher-01.jpg') }}" alt="Image Here">
                        </figure>
                        <div class="text">
                            
                            <h4><a href="{{ url('equipe-detalhes', []) }}">Anna Doe</a></h4>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="iq_teacher_style_1">
                       ...
                       <figure>
                            <img src="{{ asset('Template user/extra-images/teacher-02.jpg') }}" alt="Image Here">
                        </figure>
                    </div>
                </div>
                <!--Teacher Thumb End-->
